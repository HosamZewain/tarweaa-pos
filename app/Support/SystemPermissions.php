...
class SystemPermissions
{
    ...
    public static function resourcePermissions(): array
    {
        ...
        $resources = [
            ...
            'employees' => ['group' => 'HR', 'singular' => 'موظف', 'plural' => 'الموظفون'],
            'employee_advances' => ['group' => 'HR', 'singular' => 'سلفة موظف', 'plural' => 'سلف الموظفين'],
            'employee_salaries' => ['group' => 'HR', 'singular' => 'راتب موظف', 'plural' => 'رواتب الموظفين'],
            'employee_penalties' => ['group' => 'HR', 'singular' => 'جزاء موظف', 'plural' => 'جزاءات الموظفين'],
            ...
            'production_recipes' => ['group' => 'المخزون', 'singular' => 'وصفة إنتاج', 'plural' => 'وصفات الإنتاج'],
            'production_batches' => ['group' => 'المخزون', 'singular' => 'دفعة إنتاج', 'plural' => 'دفعات الإنتاج'],
            ...
            'user_meal_benefit_profiles' => ['group' => 'HR', 'singular' => 'ملف مزايا وجبات', 'plural' => 'ملفات مزايا الوجبات'],
    ...
    public static function pagePermissions(): array
    {
        return [
            ...
            ['name' => 'hr.overview.view', 'display_name' => 'عرض نظرة عامة HR', 'group' => 'HR'],
            ['name' => 'hr.payroll.view', 'display_name' => 'عرض صفحة مسير الرواتب', 'group' => 'HR'],
            ['name' => 'reports.sales.view', 'display_name' => 'عرض تقرير المبيعات', 'group' => 'التقارير'],
            ['name' => 'reports.items.view', 'display_name' => 'عرض تقرير الأصناف', 'group' => 'التقارير'],
    ...
    public static function actionPermissions(): array
    {
        return [
            ...
            ['name' => 'employee_advances.cancel', 'display_name' => 'إلغاء سلفة موظف', 'group' => 'HR'],
            ['name' => 'hr.payroll.generate', 'display_name' => 'توليد مسير الرواتب', 'group' => 'HR'],
            ['name' => 'hr.payroll.approve', 'display_name' => 'اعتماد مسير الرواتب', 'group' => 'HR'],
