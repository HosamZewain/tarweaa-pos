...
class AdminActivityLogService
{
    ...
    private function moduleInfoFor(Model $model): array
    {
        return match ($model::class) {
            ...
            \App\Models\EmployeeAdvance::class => ['employee_advances', 'سلفة موظف'],
            \App\Models\EmployeeSalary::class => ['employee_salaries', 'راتب موظف'],
            \App\Models\EmployeePenalty::class => ['employee_penalties', 'جزاء موظف'],
            \App\Models\PayrollRun::class => ['payroll_runs', 'مسير رواتب'],
            ...
            \App\Models\ProductionRecipe::class => ['production_recipes', 'وصفة إنتاج'],
            \App\Models\ProductionBatch::class => ['production_batches', 'دفعة إنتاج'],
